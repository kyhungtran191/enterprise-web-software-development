...
export function NewAcademicYearForm() {
  ...
  const [startClosureDate, setStartClosureDate] = useState(null)
  const [endClosureDate, setEndClosureDate] = useState(null)
  const [finalClosureDate, setFinalClosureDate] = useState(null)
  const queryClient = useQueryClient()
  const { isLoading, mutate } = useMutation({
    mutationFn: (data) => AcademicYears.createAcademicYear(data)
  })
  ...
  const formSchema = z.object({
    ...
    finalClosureDate: z.date().refine(
      ...
      {
        message: 'Final closure date must be after end closure date.'
      }
    )
  })

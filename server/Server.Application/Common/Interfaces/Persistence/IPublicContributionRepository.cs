...
namespace Server.Application.Common.Interfaces.Persistence
{
    ...
    {
        Task<PagedResult<PublicContributionInListDto>> GetAllPaging(string? keyword, string? year, string? facultyName, string? status, int pageIndex = 1, int pageSize = 10, bool? GuestAllowed = false);
